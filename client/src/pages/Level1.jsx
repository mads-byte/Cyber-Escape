...
function Level1({ currentLevel, setCurrentLevel }) {
  if (currentLevel < 1) {
  ...
  return (
    <div className="level-page-container">
      <header className="level-header">
        <h1 className="level-title">Level 1: SQL Injection Defense</h1>
      ...
      <section className="cards-grid level1-grid">
      ...
      <section className="level-controls">
        ...
        {showResults && (
          <div className="results-panel">
            ...
            {/* ✅ Unlock Level 2 only when ALL answers are correct */}
            {correctCount === total && (
              <button
                type="button"
                className="primary-button"
